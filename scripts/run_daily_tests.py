...
Usage:
    ...
    python scripts/run_daily_tests.py --keys 3
    python scripts/run_daily_tests.py --dry-run
"""
...
TESTQA2 = SCRIPTS_DIR / "testQA2.py"
RESULTS_FILE = SCRIPTS_DIR / "testQA2_results.json"
PLAN_FILE = SCRIPTS_DIR / "testQA2_plan.json"
...
def main():
    ...
    if remaining > 0:
        ...
        print(f"\n📌 วันถัดไป: python scripts/run_daily_tests.py")
    else:
